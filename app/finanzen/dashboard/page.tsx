    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: t("finanzen.invested"), value: data?.totalInvested ?? 0, icon: TrendingUp, color: "text-blue-600", bg: "bg-blue-50 dark:bg-blue-950" },
      ...
      {/* Quick Nav */}
      <section>
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">{t("finanzen.sections")}</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {[
            ...
            { href: "/finanzen/benachrichtigungen", label: t("common.notifications"), icon: AlertTriangle, color: "text-orange-500", badge: data?.unreadAlerts.length },
      ...
      {data && data.recentExpenses.length > 0 && (
        <section>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">{t("finanzen.recentExpenses")}</h2>
      ...
      {data && data.unreadAlerts.length > 0 && (
        <section>
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">{t("finanzen.unreadAlerts")}</h2>
