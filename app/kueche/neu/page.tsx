...
export default function NeuesGerichtPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.name.trim() || !form.kochgeraet) {
      setError("Name und Kochgerät sind Pflichtfelder.");
      return;
    }
    setLoading(true);
    setError("");
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Neues Gericht</h1>
          <p className="text-sm text-gray-500">Rezept anlegen</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 space-y-4">
          <h2 className="font-semibold text-gray-900 dark:text-white">Grundangaben</h2>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Kochgerät *</label>
            <select
              required
              ...
              className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
              <option value="">— Kochgerät wählen —</option>
              {kochgeraete.map((g) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {leistungen.length > 0 && (
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Leistung</label>
                <select
                  value={form.leistung}
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Minuten</label>
              <input
                type="number"
                min="0"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Portionen</label>
              <input
                type="number"
                min="1"
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-gray-700 dark:text-gray-300">Als Favorit markieren</span>
          </label>
        </div>

        {/* Zutaten */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 space-y-3">
          <h2 className="font-semibold text-gray-900 dark:text-white">Zutaten</h2>
          <div className="flex gap-2">
            <input
              type="text"
              value={zutatInput}
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            {loading ? "Speichere…" : "Gericht anlegen"}
          </button>
        </div>
      </form>
    </div>
