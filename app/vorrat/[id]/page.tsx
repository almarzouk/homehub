    ...
    return (
      <div className="max-w-2xl mx-auto space-y-5">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Produkt bearbeiten</h1>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5">Einheit</label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5">Mindestmenge</label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5">MHD</label>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm">In Einkaufsliste</span>
          </label>
        </div>

        <div className="flex gap-3">
          <button onClick={() => setEditing(false)} className="flex-1 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">Abbrechen</button>
    ...
    <div className="max-w-xl mx-auto space-y-5">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">
        <div className="px-5 py-3 flex justify-between text-sm">
          <span className="text-gray-500">Mindestmenge</span>
          <span className="font-medium">{product.minQuantity} {UNIT_LABELS[product.unit] ?? product.unit}</span>
        </div>
        {product.location && (
          <div className="px-5 py-3 flex justify-between text-sm">
        ...
        {product.expiryDate && (
          <div className="px-5 py-3 flex justify-between text-sm">
            ...
            <span className="font-medium">{new Date(product.expiryDate).toLocaleDateString("de-DE")}</span>
          </div>
        )}
        {product.notes && (
      ...
      <button onClick={toggleShoppingList}
        ...
        {product.inShoppingList ? "Von Einkaufsliste entfernen" : "Zur Einkaufsliste hinzufügen"}
      </button>
    </div>
  );
}
